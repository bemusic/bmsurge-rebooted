...
it('takes the playhead from others’ requested times', () => {
  expect(getTimeToEnqueue(100, [], { ...settings, allRequestedTimes: [400, 411, 422, 432] })).toBe(401)
  expect(getTimeToEnqueue(100, [], { ...settings, allRequestedTimes: [400, 409, 422, 432] })).toBe(410)
  expect(getTimeToEnqueue(100, [], { ...settings, allRequestedTimes: [400, 402, 411, 422, 432] })).toBe(403)
  expect(getTimeToEnqueue(100, [], { ...settings, allRequestedTimes: [400, 402, 403, 411, 422, 432] })).toBe(404)
})
